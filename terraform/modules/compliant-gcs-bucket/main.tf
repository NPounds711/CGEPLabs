...
# SC-12: cryptographic key establishment — consumer-owned key, not Google-managed.
...
# SC-13 / SC-28: CMEK at rest with 90-day automatic rotation.
...
# AC-3 + SC-28 + CM-6 + AU-11: enforced in a single resource; consumers cannot override.
